...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\kmwtb\\Desktop\\Semester IX\\NS201\\Assignment SP\\code\\experiment_lastrun.py',
...
instruct_text = visual.TextStim(win=win, name='instruct_text',
    ...
    font='Arial',
    pos=(0, 0), height=0.0325, wrapWidth=None, ori=0, 
...
text_3 = visual.TextStim(win=win, name='text_3',
    ...
    font='Arial',
    pos=(0, -0.2), height=0.0325, wrapWidth=None, ori=0, 
...
text_6 = visual.TextStim(win=win, name='text_6',
    ...
    font='Arial',
    pos=(0, -0.3), height=0.0325, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-1.0);
...
_key_resp_6_allKeys = []
# keep track of which components have finished
example1Components = [text_3, key_resp_6]
for thisComponent in example1Components:
    thisComponent.tStart = None
    thisComponent.tStop = None
    thisComponent.tStartRefresh = None
    thisComponent.tStopRefresh = None
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
example1Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "example1"-------
while continueRoutine:
    # get current time
    t = example1Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=example1Clock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
_key_resp_3_allKeys = []
# keep track of which components have finished
example2Components = [text_4, image_2, key_resp_3]
for thisComponent in example2Components:
    thisComponent.tStart = None
    thisComponent.tStop = None
    thisComponent.tStartRefresh = None
    thisComponent.tStopRefresh = None
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
example2Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "example2"-------
while continueRoutine:
    # get current time
    t = example2Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=example2Clock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
    ...
    if key_resp_3.status == STARTED and not waitOnFlip:
        theseKeys = key_resp_3.getKeys(keyList=['up'], waitRelease=False)
...
_key_resp_4_allKeys = []
# keep track of which components have finished
example3Components = [text_5, text_6, key_resp_4]
for thisComponent in example3Components:
    thisComponent.tStart = None
    thisComponent.tStop = None
    thisComponent.tStartRefresh = None
    thisComponent.tStopRefresh = None
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
example3Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "example3"-------
while continueRoutine:
    # get current time
    t = example3Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=example3Clock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
_key_resp_5_allKeys = []
# keep track of which components have finished
get_readyComponents = [text_7, key_resp_5]
